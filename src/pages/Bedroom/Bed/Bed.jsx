...
Beds.map(items => (
    ...
    <div className=" rounded relative flex  flex-col justify-center items-center    border my-[10px]  md:min-w-[150px] ">
        <div className=" max-w-[300px]  h-full ">
        <img src={items.Img} alt="" className="w-full h-full " />
        </div>
       <div className="flex w-full  bottom-0 left-0 right-0  bg-black p-2 rounded flex-row justify-between ">
            <div>
